...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" routerLink="/technicien/materielsTechnicien">
      <i class="bi bi-wrench"></i>
      <span>Materiels</span>
    </a>
  </li>
  <!--li class="nav-item">
    <a class="nav-link collapsed" routerLink="/admin/incident">
...
export class SidebarTechnicienComponent {
