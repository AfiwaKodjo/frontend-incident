...
@Component({
  selector: 'app-update-procedure-technicien',
  standalone: true,
...
export class UpdateProcedureTechnicienComponent implements OnInit{
  idProcedure!: number;
  ...
  onSubmit(){
    ...
    this.procedureService.updateProcedure(this.idProcedure, procedure).subscribe(data =>{
      ...
      this.router.navigate(['/technicien/proceduresTechnicien']);
