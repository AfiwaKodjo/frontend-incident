...
@Component({
  selector: 'app-incident-details-technicien',
  standalone: true,
            ...
            <div class="card">
                <div class="card-block">
                    ...
                    <ul class="task-list">
                        ...
                        <li>
                            <i class="task-icon bg-c-green"></i>
                            <h6>Canal de l'incident :</h6>
                            <p class="text-muted">{{incident.canalIncident}}</p>
                        </li>
                        <li>
                            <i class="task-icon bg-c-green"></i>
...
export class IncidentDetailsTechnicienComponent implements OnInit{
