...
@Component({
  selector: 'app-agences-responsable',
  standalone: true,
...
export class AgencesResponsableComponent implements OnInit{
  form: any = {};
...
updateAgence(idAgence: number){
  this.router.navigate(['responsable/update-agences/idAgence', idAgence]);
}
