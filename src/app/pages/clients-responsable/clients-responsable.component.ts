...
@Component({
  selector: 'app-clients-responsable',
  standalone: true,
                      ...
                      <br>
                        ...
                        <div class="form-group">
                          ...
                          <select [(ngModel)]="client.utilisateur" class="form-control" name="utilisateur">
                            <option [ngValue]="undefined">--Sélectionnez un technicien--</option>
                            <!-- <option *ngFor="let utilisateur of utilisateurs" [ngValue]="utilisateur" [disabled]="utilisateur.role === 'ADMIN'">{{utilisateur.nom}}</option> -->
                            <ng-container *ngFor="let utilisateur of utilisateurs">
                              <option *ngIf="utilisateur.role !== 'ADMIN' && utilisateur.role !== 'DIRECTEUR' && utilisateur.role !== 'ATTENTE'" [ngValue]="utilisateur">{{utilisateur.nom}}</option>
                            </ng-container>
...
export class ClientsResponsableComponent implements OnInit{
  ...
  clientDetails(idClient: number){
    this.router.navigate(['responsable/clientDetails/id', idClient]);
  }
 ...
 /* deleteClient(idClient: number){
  ...
  updateClient(idClient: number){
    this.router.navigate(['responsable/update-clients/idClient', idClient]);
  }
