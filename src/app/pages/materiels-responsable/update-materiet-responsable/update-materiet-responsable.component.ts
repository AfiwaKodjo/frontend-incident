...
@Component({
  selector: 'app-update-materiet-responsable',
  standalone: true,
...
export class UpdateMaterietResponsableComponent implements OnInit{
  idMateriel!: number;
  ...
  onSubmit(){
    ...
    (error: HttpErrorResponse) => {
      if (error.status === 500) {
        ...
        this.router.navigate(['/responsable/materielsResponsable']);
