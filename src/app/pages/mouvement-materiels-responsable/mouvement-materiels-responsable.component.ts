...
@Component({
  selector: 'app-mouvement-materiels-responsable',
  standalone: true,
...
<div class="container mt-3">
  ...
  <ng-container *ngFor="let mouvementMateriel of mouvementMateriels">
    <tr *ngIf="mouvementMateriel.libelleMouvement_Materiel === 'SORTIE' && mouvementMateriel.statut === 'En attente de validation'">
      ...
      <td>
            <button type="button" class="btn btn-outline-info btn-circle btn-lg btn-circle ml-0" (click)="validateMouvement(mouvementMateriel.idMouvement_Materiel)"><i class="fa fa-edit" style="color: royalblue;"></i> </button>
...
export class MouvementMaterielsResponsableComponent implements OnInit{
  ...
  onSubmit(){ 
    ...
    let mouvementMaterielModel: any = {libelleMouvement_Materiel:"ENTREE", quantiteMouvement_Materiel: this.mouvementMateriel.quantiteMouvement_Materiel, date: this.mouvementMateriel.date, objet: this.mouvementMateriel.objet,
  ...
  updateMouvementMateriel(idMouvement_Materiel: number){
      this.router.navigate(['responsable/update-mouvements/idMouvement_Materiel', idMouvement_Materiel]);
    }    
