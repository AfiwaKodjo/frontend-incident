...
@Component({
  selector: 'app-procedures-responsable',
  standalone: true,
  ...
  <tbody>
    <tr *ngFor="let procedure of procedures">
      ...
      <!-- <td><h2>{{materiel?.procedure?.nomProcedure}}</h2></td> -->
      <td>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Nouvelle procédure</h5>
                  ...
                  <div class="col">
                    <div class="row">
                      ...
                      <!--br-->
                        ...
                        <!--div class="form-group">
                          <label for="utilisateur" class="col-form-label col-sm-2">Matériel</label>
                          <select [(ngModel)]="materiel.procedure" class="form-control" name="materiel">
...
export class ProceduresResponsableComponent implements OnInit{
  form: any = {};
  ...
  constructor(private proceduresService: ProceduresService, private router: Router, private materielsService: MaterielsService) { }
...
updateProcedure(idProcedure: number){
  this.router.navigate(['responsable/update-procedures/idProcedure', idProcedure]);
}
