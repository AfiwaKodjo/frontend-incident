              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" #myForm="ngForm" (ngSubmit)="createRegister()">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" (click)="checkIfUsernameEmpty()" type="submit">Identification</button>
                    </div>
                    <div class="col-12">
...
export class RegisterComponent{
 ...
 role!:string;
  ...
  checkIfUsernameEmpty() {
    if (!this.nom && !this.prenom && !this.mot_de_passe && !this.email && this.role) {
